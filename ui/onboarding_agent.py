...
QUESTIONS = [
    ...
    {
        "field": "soil_ph",
        "question": "How acidic or alkaline is your soil? (pH value, usually between 4 and 9)",
        "help": "If you don't know, you can check with a pH meter or soil test kit. Healthy soil is usually 6 to 7.",
        "unit": "pH",
        "min": 0.0,
        "max": 14.0,
        "category": "Chemical",
        "icon": "⚗️",
        "skip_label": "I don't know my pH",
    },
    {
    ...
    {
        "field": "nitrogen_ppm",
        "question": "What is your soil nitrogen level? (in ppm)",
        "help": "From a soil test report. If you don't have one, skip this and we'll help you get one.",
        "unit": "ppm",
        "min": 0.0,
        "max": 500.0,
        "category": "Chemical",
        "icon": "🌿",
        "skip_label": "No soil test yet",
    },
    {
        "field": "phosphorus_ppm",
        "question": "What is your phosphorus level? (in mg/kg or ppm)",
        "help": "From your soil test. Plants need phosphorus for roots and flowering.",
        "unit": "mg/kg",
        "min": 0.0,
        "max": 500.0,
        "category": "Chemical",
        "icon": "🌱",
        "skip_label": "No soil test",
    },
    {
        "field": "potassium_ppm",
        "question": "What is your potassium level? (in mg/kg)",
        "help": "From your soil test. Potassium helps plants resist disease.",
        "unit": "mg/kg",
        "min": 0.0,
        "max": 2000.0,
        "category": "Chemical",
    ...
    {
        "field": "organic_matter_pct",
        "question": "What is your soil organic matter percentage?",
        "help": "Healthy farm soil has 3-5% organic matter. Compacted/depleted soils have under 2%.",
        "unit": "%",
        "min": 0.0,
        "max": 30.0,
        "category": "Chemical",
    ...
    {
        "field": "ec_ds_m",
        "question": "What is your soil electrical conductivity (EC)?",
        "help": "Measures salt levels. Above 4 dS/m means your soil is too salty.",
        "unit": "dS/m",
        "min": 0.0,
        "max": 30.0,
        "category": "Chemical",
    ...
    {
        "field": "microbial_biomass_mg_c_kg",
        "question": "What is your microbial biomass carbon level?",
        "help": "Soil life. Healthy soil has 200+ mg C/kg. Lab test required.",
        "unit": "mg C/kg",
        "min": 0.0,
        "max": 5000.0,
        "category": "Biological",
        "icon": "🦠",
        "skip_label": "No lab test",
    },
    {
        "field": "soil_respiration_mg_co2_kg_day",
        "question": "What is your soil respiration rate?",
        "help": "How active soil microbes are. Healthy soil: 25+ mg CO₂/kg/day.",
        "unit": "mg CO₂/kg/day",
        "min": 0.0,
        "max": 500.0,
        "category": "Biological",
